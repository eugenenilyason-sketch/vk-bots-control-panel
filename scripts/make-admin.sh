...
echo "   3. Откройте https://yourdomain.com/admin.html"
echo ""
echo "🔐 Доступные URL:"
echo "   - Админка: https://yourdomain.com/admin.html"
echo "   - Настройки: https://yourdomain.com/settings.html"
echo "   - Dashboard: https://yourdomain.com/dashboard.html"
echo ""
