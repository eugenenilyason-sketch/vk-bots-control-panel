  ...
  "skills": [
    {
      "name": "review",
      "enabled": true,
      "description": "Ревью кода: безопасность, производительность, качество"
    },
    {
      "name": "docker",
      "enabled": true,
      "description": "Docker контейнеризация, Docker Compose, оптимизация образов"
    },
    {
      "name": "nodejs-backend",
      "enabled": true,
      "description": "Node.js backend: Express/Fastify, middleware, API design"
    },
    {
      "name": "react-frontend",
      "enabled": true,
      "description": "React frontend: компоненты, хуки, state management"
    },
    {
      "name": "database-design",
      "enabled": true,
      "description": "Проектирование БД: PostgreSQL, схемы, миграции, индексы"
    },
    {
      "name": "oauth-auth",
      "enabled": true,
      "description": "OAuth 2.0: VK, JWT, сессии, refresh tokens"
    },
    {
      "name": "payment-integration",
      "enabled": true,
      "description": "Платёжные системы: ЮKassa, CloudPayments, webhook handling"
    },
    {
      "name": "vk-api",
      "enabled": true,
      "description": "VK API: боты, сообщения, long polling, методы API"
    },
    {
      "name": "n8n-workflows",
      "enabled": true,
      "description": "n8n workflow automation: триггеры, ноды, интеграции"
    },
    {
      "name": "nocodb-setup",
      "enabled": true,
      "description": "NocoDB: таблицы, views, API keys, permissions"
    },
    {
      "name": "security-hardening",
      "enabled": true,
      "description": "Безопасность: CORS, rate limiting, XSS, CSRF, SQL injection"
    },
    {
      "name": "performance-opt",
      "enabled": true,
      "description": "Оптимизация: кэширование, CDN, lazy loading, bundle size"
    },
    {
      "name": "pwa-mobile",
      "enabled": true,
      "description": "PWA: service workers, offline mode, mobile optimization"
    },
    {
      "name": "nginx-proxy",
      "enabled": true,
      "description": "Nginx: reverse proxy, SSL, domain routing, headers"
    }
  ],
  "roles": [
    {
      "name": "Solution Architect",
      "description": "Архитектура системы, выбор технологий, проектирование API",
      "responsibilities": [
    ...
    },
    {
      ...
      "description": "Разработка frontend + backend",
      "responsibilities": [
    ...
    },
    {
      ...
      "description": "Инфраструктура, деплой, мониторинг",
      "responsibilities": [
